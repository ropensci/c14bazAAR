...
|----------|-------------|
| [**14cpalaeolithic**](https://ees.kuleuven.be/geography/projects/14c-palaeolithic) <br> 2026-04-01 (V33) <br> [`get_c14data("14cpalaeolithic")`](R/get_14cpalaeolithic.R) | Radiocarbon Palaeolithic Europe Database. |
...
| [**calpal**](https://uni-koeln.academia.edu/BernhardWeninger/CalPal) <br> 2020-08-20 <br> [`get_c14data("calpal")`](R/get_calpal.R) | Radiocarbon Database of the [CalPal software tool](https://zenodo.org/records/20023845) by Bernhard Weninger. c14bazAAR accesses an old mirror at [nevrome/CalPal-Database](https://github.com/nevrome/CalPal-Database). Newer versions may be available within the software. |
...
| [**tegiszhol**](https://doi.org/10.5281/zenodo.21752346) <br> 2026-08-02 (v1.1) <br> [`get_c14data("tegiszhol")`](R/get_tegiszhol.R) | Radiocarbon determinations extracted from Russian-, Kazakh- and Ukrainian-language publications covering the Eurasian steppe and forest-steppe, with a per-record freshwater reservoir assessment, by [Conor Reid](https://calgacus.srht.site/tegiszhol/). Roughly 90% do not appear in any other public compilation. |
